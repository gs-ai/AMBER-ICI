...
| `qwen35-claude-coder-english:latest`                           | qwen35        |   9.7B | 262 144 (256K) |     4 096 | 6.6 GB | completion · tools · thinking · vision          | 3 weeks ago  |
...
- `qwen-investigator2-tuned`, `qwen-coder-optimized`, `huihui_ai/qwen3.5-abliterated:9b`, and `qwen35-claude-coder-english` all share the same 9.7B qwen35 base weights (262K native context).
